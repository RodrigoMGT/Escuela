...
fun BusScheduleApp(
    ...
    val fullScheduleTitle = stringResource(R.string.agenda)
...
fun BusScheduleScreen(
    ...
    val stopNameText = if (stopName == null) {
        stringResource(R.string.nombre_parada)
    } else {
        "$stopName ${stringResource(R.string.parada)}"
    }
    ...
    Column(
        ...
        Row(
            ...
            Text(stopNameText)
            Text(stringResource(R.string.hora_llegada))
        }
        Divider()
        BusScheduleDetails(
